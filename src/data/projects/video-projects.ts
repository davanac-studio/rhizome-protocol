...
export const videoProjects: Project[] = [
  {
    ...
    dueDate: "2024-03-15",
    thumbnail: "https://images.unsplash.com/photo-1605810230434-7631ac76ec81", // Image montrant des écrans multiples, adapté pour un contenu explicatif
  ...
  },
  {
    ...
    dueDate: "2024-04-01",
    thumbnail: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30", // Image d'un événement festif
    category: "Rédaction/Production audiovisuelle",
